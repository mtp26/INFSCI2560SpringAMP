...
create table Study ( studyId int auto_increment, title varchar(300), length int, compensationAmount numeric, compensationType varchar(20), eligibility text, description text, startDate date, endDate date,  IBR varchar(20), ownerId int, primary key (studyId), foreign key (ownerId) references Researcher (researcherId) );
